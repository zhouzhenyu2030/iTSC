...
- (void)didFailWithError:(NSError *)error {
    ...
    NSLog(@"SimplePing: didFailWithError.");
...
- (void)didFailWithHostStreamError:(CFStreamError)streamError {
    NSLog(@"SimplePing: didFailWithHostStreamError.");
...
static void SocketReadCallback(CFSocketRef s, CFSocketCallBackType type, CFDataRef address, const void *data, void *info) {
    NSLog(@"SimplePing: SocketReadCallback.");
...
- (void)startWithHostAddress {
    NSLog(@"SimplePing: startWithHostAddress.");
    int                     err;
    int                     fd;
...
- (void)hostResolutionDone {
    NSLog(@"SimplePing: hostResolutionDone.");
    Boolean     resolved;
    NSArray *   addresses;
...
static void HostResolveCallback(CFHostRef theHost, CFHostInfoType typeInfo, const CFStreamError *error, void *info) {
     NSLog(@"SimplePing: HostResolveCallback.");
...
- (void)start {
    ...
    if ( self.host == NULL)
    {
        NSLog(@"SimplePing: Start: host == NULL.");
     }
    
    
    bool isOK=CFHostSetClient(self.host, HostResolveCallback, &context);
    if ( isOK == false)
    {
        NSLog(@"SimplePing: Start: CFHostSetClient == false.");
    }
    ...
    if ( ! success ) {
        NSLog(@"SimplePing: Start: not success.");
        [self didFailWithHostStreamError:streamError];
    }
    NSLog(@"SimplePing: Start: is called.");
}
