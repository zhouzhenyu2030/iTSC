...
@implementation HADrawChartView
...
-(void)Init
{
    NSLog(@"HisAssetChartView: viewDidLoad: start.");

    //if(_linechartView!=nil)
    //    return;
    
    //保存View
    [TscConst setHADrawChartView:self];
...
{
    NSLog(@"HisAssetChartView: initLineChartView: start.");
    ...
    frame.size.width -=100;//= self.view.bounds.size.width-50;
    frame.size.height -=300;// self.view.bounds.size.height-200;
    ...
    NSLog(@"HisAssetChartView: initLineChartView: over.");
}
...
{
    NSLog(@"HisAssetChartView: initLineChartDataWithXvalueArr: start.");
    
    if(_linechartView==nil)
    {
        NSLog(@"HisAssetChartView: initLineChartDataWithXvalueArr: _linechartView==nil.");
        [self initLineChartView];
    }
    ...
    NSLog(@"HisAssetChartView: initLineChartDataWithXvalueArr: over.");
}
